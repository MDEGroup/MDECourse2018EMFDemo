 ...
 * @generated
 */
public class WebasiteSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WebasitePackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebasitePackage.WEB_MODEL: {
				WebModel webModel = (WebModel)theEObject;
				T result = caseWebModel(webModel);
				if (result == null) result = caseNamedElement(webModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebasitePackage.WEB_ELEMENT: {
				WebElement webElement = (WebElement)theEObject;
				T result = caseWebElement(webElement);
				if (result == null) result = caseNamedElement(webElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebasitePackage.PAGE: {
			...
			case WebasitePackage.ENTITY: {
				Entity entity = (Entity)theEObject;
				T result = caseEntity(entity);
				if (result == null) result = caseWebElement(entity);
				if (result == null) result = caseNamedElement(entity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebasitePackage.FORM: {
